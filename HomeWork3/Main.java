...
public class Main implements IConst {
    ...
    public static void main(String[] args) {
        Cat person = new Cat("Мэйсон", 11, "Hi"); 
        ...
        MyInter inter2 = (y) -> y - 11;
        System.out.println("Юбилей через " + inter.getMyInter(11) + " года (лет)");
    ...
    public String toString(){
       ...
       List<Animal> cats = new ArrayList<>();
        cats.add(new Animal("Буся", 3, 5,"белый"));
        cats.add(new Animal("Серко", 3, 5,"серый"));
        cats.add(new Animal("Рыжик", 10, 7,"рыжий"));
        cats.add(new Animal("Васька", 7, 3,"черный"));
